...
```bash
# 1. Merge
{{PYTHON_PATH}} .claude/doc-advisor/scripts/merge_specs_toc.py --mode full --cleanup
...
```bash
# 1. Merge
{{PYTHON_PATH}} .claude/doc-advisor/scripts/merge_specs_toc.py --mode incremental --cleanup
