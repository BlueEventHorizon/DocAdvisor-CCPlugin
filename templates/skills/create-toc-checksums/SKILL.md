...
### For rules: `{{RULES_DIR}}/.toc_checksums.yaml`
...
### For specs: `{{SPECS_DIR}}/.toc_checksums.yaml`
...
file_count: 50
checksums:
  main/{{REQUIREMENT_DIR_NAME}}/screens/login_screen.md: a1b2c3d4e5f6...
  main/{{DESIGN_DIR_NAME}}/login_screen_design.md: b2c3d4e5f6a1...
  ...
```
