...
description: Merges completed YAML entries from .claude/doc-advisor/specs/.toc_work/ and generates/validates specs_toc.yaml. Used in Phase 3 merge processing of specs_toc updates.
...
Merges completed YAML files from .claude/doc-advisor/specs/.toc_work/ and generates/validates .claude/doc-advisor/specs/specs_toc.yaml.
...
python3 .claude/skills/merge-specs-toc/create_pending_yaml.py
```
...
1. Read `.claude/doc-advisor/specs/.toc_work/*.yaml` (excluding `_deleted.txt`)
...
6. Generate `.claude/doc-advisor/specs/specs_toc.yaml`
...
- **Full/Incremental Mode**: YAML files with completed status must exist in `.claude/doc-advisor/specs/.toc_work/`
- **Delete-only Mode**: `.claude/doc-advisor/specs/.toc_checksums.yaml` must exist
